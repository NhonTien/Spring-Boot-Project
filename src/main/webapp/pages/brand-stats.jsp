...
<html>
<head>
<title>Thống kê thương hiệu</title>
...
<body>
	...
	<div class="column-right">
		...
		<div class="container">
			<div class="sub-header">
				<div class="float-left sub-title">Thống kê Thương hiệu</div>
			</div>
			<div class="category-stats">
				<div class="columns-left">
					<canvas id="myBrandStatsChart"></canvas>
				</div>
				<div class="columns-right">
					<table class="table">
						...
						<c:forEach items="${brandStats}" var="p">
							<tr>
	...
	<script>
		let brandLabels=[], brandInfo=[]
		<c:forEach items="${brandStats}" var="p">
			brandLabels.push('${p[1]}')
			brandInfo.push(${p[2]})
		</c:forEach>
		window.onload = function(){
			brandChart("myBrandStatsChart", brandLabels, brandInfo)
		}
		...
		function brandChart(id, brandLabels, brandInfo){
			let colors=[]
			...
			const data = {
				labels: brandLabels,
				datasets: [{
					label: 'Thống kê số lượng theo thương hiệu',
					data: brandInfo,
