	...
	<div class="column-right">
		...
		<div class="container">
			<div class="sub-header">
				<div class="float-left sub-title">Quản lý Thương hiệu</div>
				<div class="float-right">
					<a class="btn btn-success add-btn" id="addBrandInfoModal"><i class="fas fa-plus-square"></i> Thêm thương hiệu</a>
				</div>
			</div>
	
			<div class="form-search">
				<div class="vals">
					<input type="text" name="keyword" id="keyword" class="sr" placeholder="Tên thương hiệu" />
					...
					<form id="brandInfoForm" role="form" enctype="multipart/form-data">
						...
						<div class="modal-body">
							<div class="form-group d-none">
								<label>ID</label> 
								<input type="text" class="form-control" name="brandId" id="brandId" placeholder="ID" readonly>
							</div>
							<div class="form-group">
								<label for="brandName">Tên thương hiệu <span class="required-mask">(*)</span></label> 
								<input type="text" class="form-control" id="brandName" name="brandName" placeholder="Tên thương hiệu">
							</div>
		...
		<div class="modal fade" id="confirmDeleteModal">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>
							Bạn chắc chắn muốn xóa <b id="deletedBrandName"></b>?
						</p>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
