	...
	<div class="column-right">
		...
		<div class="container">
			<div class="sub-header">
				<div class="float-left sub-title">Thống kê Doanh thu theo tháng</div>
			</div>
			<div id="form-report">
				...
				<div class="columns-right">
					<table class="table">
						...
						<c:forEach items="${productMonthStats}" var="p">
							<tr>
								<td align="center">${p[0]}/${p[1]}</td>
								<td align="right" id="product-months"><fmt:formatNumber type="number" pattern="###,###,###" value="${p[2]}" /> VNĐ</td>
							</tr>
						</c:forEach>
					</table>
				</div>
