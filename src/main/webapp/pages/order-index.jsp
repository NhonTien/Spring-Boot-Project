	...
	<div class="column-right">
		...
		<div class="container">
			<div class="sub-header">
				<div class="float-left sub-title">Quản lý Đơn hàng</div>
			</div>
			<div class="form-search">
	        	<div class="vals">
					<input type="text" name="name" id="name" class="sr" placeholder="Tên khách hàng"/>
	                <input type="text" name="address" id="address" class="sr" placeholder="Địa chỉ"/>
	                <input type="text" name="orderDate" id="orderDate" class="sr" placeholder="Tổng tiền"/>
				...
				<form id="orderInfoForm" role="form" enctype="multipart/form-data">
					...
					<div class="modal-body orderdetail">
						...
						<div class="customerForm">
							<h5 class="customerTitle">Thông tin khách hàng</h5>
							<input class="customerInfo" id="names" readonly>
							<hr>
							<input class="customerInfo" id="phoneNumber" readonly>
							<hr>
						...
						<table class="table table-bordered" id="orderDetailsTable">
							...
							<tfoot>
								<tr>
			                        ...
			                        <td scope="col" align="right"><input id="total" readonly><span class="cart-total"><sup><u>đ</u></sup></span></td>
			                    </tr>
			                    <tr>
			                        <td scope="col" colspan="5" id="totalprice" class="info-price">Phí giao hàng</td>
			                        <td scope="col" align="right" class="feeShip"><input id="feeShip" readonly><span class="cart-total"><sup><u>đ</u></sup></span></td>
			                    ...
			                    <tr class="discount">
			                        ...
			                        <td scope="col" align="right"><input id="discount" readonly><span class="cart-total"><sup><u>đ</u></sup></span></td>
			                    </tr>
			                    <tr>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" id="saveOrderCancelBtn">Hủy đơn hàng</button>
							<button type="button" class="btn btn-primary" id="saveOrderBtn">Xác nhận</button>
						</div>
					</div>
				</form>
			</div>
